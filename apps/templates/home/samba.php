...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Samba Management</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Samba Management</a></li>
                        <li class="breadcrumb-item active">Samba Management v1</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Samba Management</h3>
                        ...
                        <div class="card-body">
                            <table id="samba" class="table table-bordered table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>User ID</th>
                                        <th>Username</th>
                                ...
                                <tbody>
                                    {% for samba_id, samba_username, samba_name in  global_variable.6 %}
                                    <tr>
                                        <td>{{samba_id}}</td>
                                        <td>{{samba_username}}</td>
                                        <td>{{samba_name}}</td>
                                        <td></td>
                                    </tr>
                                    {% endfor %}
...
<script src="/static/assets/js/crud/samba.js"></script>
<!-- SweetAlert2 -->
