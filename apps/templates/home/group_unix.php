...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Unix Group Management</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Unix Group Management</a></li>
                        <li class="breadcrumb-item active">Unix Group Management v1</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Unix Group Management</h3>
                        ...
                        <div class="card-body">
                            <table id="group_unix" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Group ID</th>
                                        <th>Group Owner</th>
                                ...
                                <tbody>
                                    {% for unix_group_id, unix_group_name, unix_group_user in global_variable.5 %}
                                    <tr>
                                        <td>{{unix_group_id}}</td>
                                        <td>{{unix_group_name}}</td>
                                        <td>{{unix_group_user}}</td>
                                        <td></td>
                                    </tr>
                                    {% endfor %}
                                </tbody>
...
<script src="/static/assets/js/crud/group_unix.js"></script>
<!-- SweetAlert2 -->
...
<script type="text/javascript">
    ...
    const html = '<select id="username" class="dt-select2 username" multiple="multiple" data-placeholder="Select a username"  style="width: 100%;">'+
